...
class KingEndgameEvaluator(FeatureEvaluator):
    def __init__(self, params: Dict[str, float]):
        ...
        self.king_opposition = params.get("king_opposition", KING_OPPOSITION)
    ...
    def evaluate(self, board: chess.Board, color: bool, phase_value: float = 1.0) -> float:
        ...
        king_dist = chess.square_distance(king_square, enemy_king_square)
        score += (7 - king_dist) * self.king_opposition
